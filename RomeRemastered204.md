...
This would allow you to use items like the level of law in a settlement as a condition of recruitment on a building. You can see a list of the [Building Capabilities](/documentation/data_file_guides/building_capabilities.md) here.
